 ...
 * （帮助fg）功能解答
 */
public class FunctionSolution extends Activity implements View.OnClickListener {


    private Activity mActivity;
    private ImageView img_back;
    private RelativeLayout rly_question_1, rly_question_2, rly_question_3, rly_question_4;
    private ImageView img_down_up_1, img_down_up_2, img_down_up_3, img_down_up_4;
    private LinearLayout lly_answer_1, lly_answer_2, lly_answer_3, lly_answer_4;
    private TextView tv_divide_1, tv_divide_2, tv_divide_3;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.help_function_solution);
